...
import * as cliInterface from '@threatcode/cli-interface';
...
import { CallGraph } from '@threatcode/cli-interface/legacy/common';
...
const debug = debugModule('threatcode-test');
