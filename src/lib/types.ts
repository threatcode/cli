...
import { legacyCommon as legacyApi } from '@threatcode/cli-interface';
import { SEVERITY } from './threatcode-test/legacy';
import { FailOn } from './threatcode-test/common';
...
export interface PolicyOptions {
  'ignore-policy'?: boolean; // used in threatcode/policy lib
  'trust-policies'?: boolean; // used in threatcode/policy lib
  'policy-path'?: string;
  loose?: boolean;
}
...
export enum SupportedCliCommands {
  ...
  about = 'about',
  help = 'help',
  // config = 'config', // TODO: cleanup `$ threatcode config` parsing logic before adding it here
