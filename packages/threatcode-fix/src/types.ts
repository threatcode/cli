import { DepGraphData } from '@threatcode/dep-graph';
...
/* Test Result
 * this data is returned on a `threatcode test` for supported project types
...
// defining only what is used by @threatcode/fix
// add more as needed
