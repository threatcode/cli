...
test('test command line arguments', (t) => {
  const cliArgs = [
    ...
    '/Users/dror/work/threatcode/threatcode-internal/cli',
    'test',
    '--',
    '-Paxis',
    '-Pjaxen',
...
test('when command line "container"', (c) => {
  c.test('set option imageSavePath via config set', (t) => {
    delete process.env['THREATCODE_IMAGE_SAVE_PATH'];
  ...
  c.test('set option imageSavePath via env var', (t) => {
    process.env['THREATCODE_IMAGE_SAVE_PATH'] = './my/custom/image/save/path';
    const cliArgs = [
      '/Users/dror/.nvm/versions/node/v6.9.2/bin/node',
      '/Users/dror/work/threatcode/threatcode-internal/cli',
      'container',
...
test('test command line "threatcode monitor --project-name-prefix" should add a property on options', (t) => {
  const cliArgs = [
    '/Users/dror/.nvm/versions/node/v6.9.2/bin/node',
    '/Users/dror/work/threatcode/threatcode-internal/cli',
    'monitor',
...
test('test command line "threatcode monitor --packages-folder" should add a property on options', (t) => {
  const cliArgs = [
    '/Users/dror/.nvm/versions/node/v6.9.2/bin/node',
    '/Users/dror/work/threatcode/threatcode-internal/cli',
    'monitor',
...
test('test command line "threatcode monitor --assets-project-name" should add a property on options', (t) => {
...
test('test command line "threatcode iac --experimental" should be true on options', (t) => {
  const cliArgsWithFlag = [
    '/Users/dror/.nvm/versions/node/v6.9.2/bin/node',
    '/Users/dror/work/threatcode/threatcode-internal/cli',
    'iac',
...
test('test command line "threatcode iac --experimental --detection-depth=1" should be 1 on options', (t) => {
  const cliArgsWithFlag = [
    '/Users/dror/.nvm/versions/node/v6.9.2/bin/node',
    '/Users/dror/work/threatcode/threatcode-internal/cli',
    'iac',
...
test('test command line "threatcode iac test --rules=./path/to/bundle.tar.gz" should have path on options', (t) => {
  const cliArgsWithFlag = [
    '/Users/dror/.nvm/versions/node/v6.9.2/bin/node',
    '/Users/dror/work/threatcode/threatcode-internal/cli',
    'iac',
