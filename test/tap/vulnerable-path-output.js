...
const threatcode = require('..');
const { getFixturePath } = require('../jest/util/getFixturePath');

sinon.stub(threatcode, 'test', function() {
  return require(getFixturePath('more-vuln-paths-than-vulns'));
});

tap.tearDown(function() {
  threatcode.test.restore();
});

test('"threatcode test --show-vulnerable-paths=false"', function(t) {
...
test('"threatcode test"', function(t) {
  return cli
