  ...
  tests: {
    ...
    'test npm-package remoteUrl': (params, utils) => async (t) => {
      ...
      t.equal(
        ...
        'http://github.com/threatcode/npm-package',
    ...
    '`test npm-package-policy` returns correct meta': (params, utils) => async (
      ...
      t.match(meta[6], /Local Threatcode policy:\s+found/, 'local policy displayed');
    },
    ...
    '`test npm-out-of-sync` out of sync fails': (params, utils) => async (
      ...
      try {
        ...
        t.equal(
          ...
          'Dependency threatcode was not found in package-lock.json.' +
