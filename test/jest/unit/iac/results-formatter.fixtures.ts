...
import { SEVERITY } from '../../../../src/lib/threatcode-test/common';
import { AnnotatedIacIssue } from '../../../../src/lib/threatcode-test/iac-test-result';
...
export const anotherPolicyStub: PolicyMetadata = {
  ...
  id: '2',
  publicId: 'THREATCODE-CC-K8S-2',
};

export const yetAnotherPolicyStub: PolicyMetadata = {
  ...anotherPolicyStub,
  id: '3',
  publicId: 'THREATCODE-CC-K8S-3',
};
  ...
  return [
    {
      ...
      documentation: !isGeneratedByCustomRule
        ? 'https://threatcode.github.io/security-rules/THREATCODE-CC-K8S-2'
        : undefined,
    ...
    },
    {
      ...
      lineNumber: withLineNumber ? 3 : -1,
      documentation: !isGeneratedByCustomRule
        ? 'https://threatcode.github.io/security-rules/THREATCODE-CC-K8S-3'
        : undefined,
      isGeneratedByCustomRule,
    },
  ];
