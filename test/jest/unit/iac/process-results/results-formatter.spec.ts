...
import * as cloudConfigParserModule from '@threatcode/cloud-config-parser';
import {
  EngineType,
  PolicyMetadata,
} from '../../../../../src/cli/commands/test/iac/local-execution/types';

jest.mock('@threatcode/cloud-config-parser', () => ({
  ...jest.requireActual('@threatcode/cloud-config-parser'),
}));
