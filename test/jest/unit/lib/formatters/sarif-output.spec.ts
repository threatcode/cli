...
import { SEVERITY, TestResult } from '../../../../../src/lib/threatcode-test/legacy';
    ...
    vulnerabilities: [
      {
        ...
        id: 'THREATCODE-LINUX-EXPAT-450908',
        identifiers: {
          ALTERNATIVE: [
            'THREATCODE-DEBIAN8-EXPAT-450909',
            'THREATCODE-DEBIAN9-EXPAT-450910',
            'THREATCODE-DEBIANUNSTABLE-EXPAT-450911',
            'THREATCODE-DEBIAN10-EXPAT-450912',
            'THREATCODE-UBUNTU1404-EXPAT-451027',
            'THREATCODE-UBUNTU1204-EXPAT-451028',
            'THREATCODE-UBUNTU1810-EXPAT-451029',
            'THREATCODE-UBUNTU1604-EXPAT-451030',
            'THREATCODE-UBUNTU1804-EXPAT-451031',
            'THREATCODE-ALPINE38-EXPAT-451858',
            'THREATCODE-ALPINE39-EXPAT-453353',
            'THREATCODE-ALPINE37-EXPAT-453374',
            'THREATCODE-ALPINE310-EXPAT-453902',
            'THREATCODE-DEBIAN11-EXPAT-518187',
            'THREATCODE-UBUNTU1904-EXPAT-531483',
          ],
          CVE: ['CVE-2018-20843'],
          CWE: ['CWE-611'],
        },
