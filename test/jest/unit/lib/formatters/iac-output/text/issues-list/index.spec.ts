...
import { SEVERITY } from '../../../../../../../../src/lib/threatcode-test/legacy';
...
describe('getIacDisplayedIssues', () => {
  ...
  Rule:    ${chalk.underline('https://threatcode.github.io/security-rules/THREATCODE-CC-AWS-426')}
  ...
  Info:    The root block device for ec2 instance is not encrypted. That should
           ...
           read the contents.
  Rule:    ${chalk.underline('https://threatcode.github.io/security-rules/THREATCODE-CC-TF-53')}
  ...
  Rule:    ${chalk.underline('https://threatcode.github.io/security-rules/THREATCODE-CC-K8S-1')}
  ...
  Rule:    ${chalk.underline('https://threatcode.github.io/security-rules/THREATCODE-CC-TF-123')}
