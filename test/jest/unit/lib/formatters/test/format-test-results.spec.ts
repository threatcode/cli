...
describe('extractDataToSendFromResults', () => {
  ...
  describe('open source results', () => {
    ...
    it('should create Threatcode JSON and only Threatcode JSON if `--json` is set in the options', () => {
      const options = {
        json: true,
      } as Options;
      const jsonStringifySpy = jest.spyOn(JSON, 'stringify');
    ...
    it('should create Threatcode JSON and only Threatcode JSON if `--json-file-output` is set in the options', () => {
      const options = {} as Options;
    ...
    it('should create Threatcode JSON and only Threatcode JSON if `--json` and `--json-file-output` are set in the options', () => {
      const options = {
        json: true,
      } as Options;
      options['json-file-output'] = 'somefile.json';
  ...
  describe('open source results grouping', () => {
    describe('single project results grouping', () => {
      ...
      it('should create grouped Threatcode JSON and only grouped Threatcode JSON if `--json` and `--group-issues` is set in the options', () => {
        const options = {
          json: true,
          'group-issues': true,
        } as Options;
      ...
      it('should create non-grouped Threatcode JSON and only Threatcode JSON if `--json` is set in the options', () => {
        const options = {
          json: true,
        } as Options;
        const jsonStringifySpy = jest.spyOn(JSON, 'stringify');
    ...
    describe('multiple project results grouping', () => {
      ...
      it('should create grouped Threatcode JSON for each of the projects in the result if `--json` and `--group-issues` is set in the options', () => {
        const options = {
          json: true,
          'group-issues': true,
        } as Options;
      ...
      it('should create non-grouped Threatcode JSON for each of the projects in the result if `--json` is set in the options', () => {
        const options = {
          json: true,
        } as Options;
        const jsonStringifySpy = jest.spyOn(JSON, 'stringify');
  ...
  describe('container image json results', () => {
    ...
    it('should create Threatcode grouped JSON for container image if `--json` and `--group-issues` are set in the options', () => {
      const options = {
        json: true,
        docker: true,
        'group-issues': true,
  ...
  describe('container app and os json results', () => {
    ...
    it('should create Threatcode grouped JSON for each of the multiple test results if `--json` and `--group-issues` are set in the options', () => {
      const options = {
        json: true,
        docker: true,
        'group-issues': true,
