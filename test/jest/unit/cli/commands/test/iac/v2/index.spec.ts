...
describe('test', () => {
  ...
  scanFixture.errors = scanFixture.errors.map(
    (scanError) => new ThreatcodeIacTestError(scanError),
  );
  ...
  describe('with no successful scans', () => {
    ...
    it('throws the expected error', async () => {
      ...
      expect(error).toMatchObject({
        ...
        }",\n          "description": {\n            "text": "The root directory for all project files."\n          }\n        }\n      },\n      "tool": {\n        "driver": {\n          "name": "Threatcode IaC",\n          "fullName": "Threatcode Infrastructure as Code",\n          "version": "1.0.0-monorepo",\n          "informationUri": "https://docs.threatcode.io/products/threatcode-infrastructure-as-code",\n          "rules": []\n        }\n      },\n      "automationDetails": {\n        "id": "threatcode-iac"\n      },\n      "results": []\n    }\n  ]\n}`,
        fields: {
          path: 'invalid_file.txt',
        },
      });
