...
build_name="threatcode-for-docker-desktop-${platform}-${arch}"
...
# Include entrypoint.
cp ./docker-desktop/src/threatcode-mac.sh "${build_dir}"

# Include Threatcode CLI build.
...
# Create Threatcode CLI for Docker Desktop build
#
