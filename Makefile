...
$(BINARY_RELEASES_FOLDER_TS_CLI)/threatcode.tgz: prepack | $(BINARY_RELEASES_FOLDER_TS_CLI)
	$(MAKE) pack-binary-wrapper
	$(MAKE) $(BINARY_RELEASES_FOLDER_TS_CLI)/threatcode.tgz.sha256

$(BINARY_RELEASES_FOLDER_TS_CLI)/threatcode-fix.tgz: prepack | $(BINARY_RELEASES_FOLDER_TS_CLI)
	mv $(shell npm pack --workspace '@threatcode/fix') $(BINARY_RELEASES_FOLDER_TS_CLI)/threatcode-fix.tgz
	$(MAKE) $(BINARY_RELEASES_FOLDER_TS_CLI)/threatcode-fix.tgz.sha256

$(BINARY_RELEASES_FOLDER_TS_CLI)/threatcode-protect.tgz: prepack | $(BINARY_RELEASES_FOLDER_TS_CLI)
	mv $(shell npm pack --workspace '@threatcode/protect') $(BINARY_RELEASES_FOLDER_TS_CLI)/threatcode-protect.tgz
	$(MAKE) $(BINARY_RELEASES_FOLDER_TS_CLI)/threatcode-protect.tgz.sha256

$(BINARY_RELEASES_FOLDER_TS_CLI)/threatcode-alpine: prepack | $(BINARY_RELEASES_FOLDER_TS_CLI)
	$(PKG) -t node16-alpine-x64 -o $(BINARY_RELEASES_FOLDER_TS_CLI)/threatcode-alpine
	$(MAKE) $(BINARY_RELEASES_FOLDER_TS_CLI)/threatcode-alpine.sha256

$(BINARY_RELEASES_FOLDER_TS_CLI)/threatcode-linux: prepack | $(BINARY_RELEASES_FOLDER_TS_CLI)
	$(PKG) -t node16-linux-x64 -o $(BINARY_RELEASES_FOLDER_TS_CLI)/threatcode-linux
	$(MAKE) $(BINARY_RELEASES_FOLDER_TS_CLI)/threatcode-linux.sha256
...
$(BINARY_RELEASES_FOLDER_TS_CLI)/threatcode-linux-arm64: prepack | $(BINARY_RELEASES_FOLDER_TS_CLI)
	$(PKG) -t node16-linux-arm64 -o $(BINARY_RELEASES_FOLDER_TS_CLI)/threatcode-linux-arm64 --no-bytecode
	$(MAKE) $(BINARY_RELEASES_FOLDER_TS_CLI)/threatcode-linux-arm64.sha256

$(BINARY_RELEASES_FOLDER_TS_CLI)/threatcode-macos: prepack | $(BINARY_RELEASES_FOLDER_TS_CLI)
	$(PKG) -t node16-macos-x64 -o $(BINARY_RELEASES_FOLDER_TS_CLI)/threatcode-macos
	$(MAKE) $(BINARY_RELEASES_FOLDER_TS_CLI)/threatcode-macos.sha256

$(BINARY_RELEASES_FOLDER_TS_CLI)/threatcode-win.exe: prepack | $(BINARY_RELEASES_FOLDER_TS_CLI)
	$(PKG) -t node16-win-x64 -o $(BINARY_RELEASES_FOLDER_TS_CLI)/threatcode-win.exe
	./cliv2/scripts/sign_windows.sh $(BINARY_RELEASES_FOLDER_TS_CLI) threatcode-win.exe
	$(MAKE) $(BINARY_RELEASES_FOLDER_TS_CLI)/threatcode-win.exe.sha256

$(BINARY_RELEASES_FOLDER_TS_CLI)/threatcode-for-docker-desktop-darwin-x64.tar.gz: prepack | $(BINARY_RELEASES_FOLDER_TS_CLI)
	./docker-desktop/build.sh darwin x64
	$(MAKE) $(BINARY_RELEASES_FOLDER_TS_CLI)/threatcode-for-docker-desktop-darwin-x64.tar.gz.sha256

$(BINARY_RELEASES_FOLDER_TS_CLI)/threatcode-for-docker-desktop-darwin-arm64.tar.gz: prepack | $(BINARY_RELEASES_FOLDER_TS_CLI)
	./docker-desktop/build.sh darwin arm64
	$(MAKE) $(BINARY_RELEASES_FOLDER_TS_CLI)/threatcode-for-docker-desktop-darwin-arm64.tar.gz.sha256
...
pack-binary-wrapper: build-binary-wrapper
	@echo "-- Packaging tarball ($(BINARY_OUTPUT_FOLDER)/threatcode.tgz)"
